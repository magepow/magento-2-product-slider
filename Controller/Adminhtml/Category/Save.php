 ...
 * @@Modify Date: 2016-04-22 16:48:43
 * @@Function:
 */
    ...
    public function execute()
    {
        ...
        if ($data = $this->getRequest()->getPostValue()) {
            ...
            if (isset($_FILES['image']) && isset($_FILES['image']['name']) && strlen($_FILES['image']['name'])) {
                ...
                try {
                    ...
                    $result = $uploader->save(
                        $mediaDirectory->getAbsolutePath('magiccart/magicproduct/category/')
                    );
                    $data['image'] = 'magiccart/magicproduct/category/'.$result['file'];
                } catch (\Exception $e) {
                    if ($e->getCode() == 0) {
            ...
            try {
                ...
                $this->messageManager->addSuccess(__('The Category Tabs has been saved.'));
